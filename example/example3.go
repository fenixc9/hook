...
func main() {
	...
	err := hook.HookMethod(a, "Id", MyId2, MyIdTrampoline2)
	if err != nil {
	...
	b := &base{id:333}
	err2 := hook.HookMethod(b, "Id", MyId, MyIdTrampoline)
	if err2 != nil {
	...
	hook.UnHookMethod(a, "Id")
	hook.UnHookMethod(b, "Id")
	...
	err3 := hook.Hook((*advance).Id, MyId2, MyIdTrampoline2)
	if err3 != nil {
	...
	err4 := hook.Hook(a.Id, MyId2, MyIdTrampoline2)
	if err4 != nil {
